...
L["Check this to show space at your bank in the plugin."] = "플러그인에서 은행의 칸을 표시하려면 선택하세요."
...
L["Check to enable this module."] = "이 모듈을 사용하려면 선택하세요."
...
L["Show only one slot of items that can be stacked."] = "겹칠 수 있는 아이템의 칸을 하나만 표시합니다."
L["Show only one slot of items that cannot be stacked."] = "겹칠 수 없는 아이템의 칸을 하나만 표시합니다."
L["Size"] = "크기"
L["Skin"] = "스킨"
L["Slot number"] = "슬롯 번호"
L["Small"] = "작게"
...
L["SOUL_BAG_TAG"] = "조각"
L["Space in use"] = "사용 중인 칸"
L["Space in use / total space"] = "사용 중인 칸 / 전체 칸"
...
L["Virtual stack slots"] = "가상 중첩 칸"
L["Virtual stacks"] = "가상 중첩"
L["Virtual stacks display in one place items that actually spread over several bag slots."] = "가상 중첩은 실제로 여러 가방 칸에 흩어져 있는 아이템을 한 곳에 표시합니다."
L["When alt is held down"] = "Alt키를 누르고 있을 때"
L["When any modifier key is held down"] = "보조 키를 누르고 있을 때"
L["When checked, right-clicking on an empty space of a bag opens the configuration panel."] = "선택된 경우, 가방의 빈 공간을 우클릭하면 설정 창을 엽니다."
